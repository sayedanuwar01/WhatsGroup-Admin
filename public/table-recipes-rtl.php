				                	...
				                	<tr>
				                		<td width="25%"><div align="right">
				                			<div class="input-field col s12">
							                    <a href="add-menu.php" class="btn waves-effect waves-light indigo">Add New Recipes</a>
							                </div></div>
				                		</td>
												...
												<tbody>
													<tr>
														...
														<td><div align="right">	
															...
															<a href="delete-menu.php?id=<?php echo $data['nid'];?>" onclick="return confirm('Are you sure want to delete this Recipe?')" >
