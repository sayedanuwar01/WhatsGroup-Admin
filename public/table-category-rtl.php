				            ...
				            <div class="row">
				                <table>
				                	<tr>
				                		<td width="25%"><div align="right">
				                			<div class="input-field col s12">
							                    <a href="add-category.php" class="btn waves-effect waves-light indigo">Add New Category</a></div>
							                </div>
				                		</td>
				                		<td width="40%"><div align="right">
				                			<div class="input-field col s12">
											...
											<?php 
												...
												<tbody>
													<tr>
														...
														<td><div align="right"><img src="upload/category/<?php echo $data['category_image']; ?>" width="64px" height="48px"/></div></td>
														<td><div align="right">
